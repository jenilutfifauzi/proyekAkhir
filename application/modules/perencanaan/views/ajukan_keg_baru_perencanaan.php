  ...
  <div class="modal-body">
    <form method="POST" action="<?= base_url('perencanaan/aksi_tambah_perintah_dateline') ?>" class="needs-validation" >
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="kode" name="kode" value="<?= $kode_urut ?>" readonly required>
        </div>
      </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <?php } else {?>
                          <a href="<?php echo base_url(); ?>perencanaan/aksi_nonaktif_unggah_ajukan_keg_baru/<?= $users['kode']?>" class="btn btn-danger"><i class="fas fa-upload"></i> NonAktif </a>
                          <?php } ?>
