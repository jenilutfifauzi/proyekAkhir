          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  ...
                  <?php echo "Rp. ".$total_anggaran->jumlah_anggaran;?>
                  </div>
                </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  ...
                  <div class="card-header">
                    <?php echo "Rp. ".$anggaran_terserap->jumlah_anggaran;?>
                  </div>
                </div>
                  </div>
                </div>
           ...
           <div class="row">
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Target Serapan Tahun ini</h5>
                  <div class="alert alert-success" role="alert">
                  <h4 class="alert-heading">Spirit!</h4>
    ...
    series: [
        {
            ...
            data: [
                {
                    name: "Terserap",
                    y: <?= $data_persen_terbaru;?>,
                    drilldown: "Terserap"
                },
                {
                    name: "Belum Terserap",
                    y: <?= (100 - $data_persen_terbaru);?>,
