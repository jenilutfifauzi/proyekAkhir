...
<div class="modal-dialog">
  ...
  <div class="modal-body">
    <form method="POST" action="<?= base_url('unit/aksi_tambah_kegiatan_baru') ?>" class="needs-validation" >
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="komponen" name="kode_subkomponen">
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="inputName" class="col-sm-2 col-form-label">Jenis Kegiatan</label>
        <div class="col-sm-10">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <a href="<?php echo base_url(); ?>unit/rab_datadukung_keg_baru/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                          <a href="<?php echo base_url(); ?>unit/submit_rab_datadukung_keg_baru/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-success"><i class="fas fa-paper-plane"></i> Validasi</a>
                          <?php }else {?>
                          <div class="badges">
